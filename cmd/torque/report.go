...
// Example:
//
//	torque-report kind=apply result=success release=monitoring namespace=default chart=tempo version=1.24.1 revision=9 elapsed_ms=4958
...
func writeReportTable(w io.Writer, r reportLine) {
	...
	// Render a single-row "resource-style" summary that matches torque's live tables.
