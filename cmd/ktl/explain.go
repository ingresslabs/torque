...
func newExplainCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "Explain a captured ktl run",
		Long:  "Explain a captured ktl deploy, build, log, or stack run from a portable SQLite evidence file.",
