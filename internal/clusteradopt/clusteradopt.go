...
// Brief: Discover live cluster state and render a starter ktl stack.
...
func RenderStackYAML(snapshot *Snapshot, opts RenderOptions) (string, []ValuesFile, []ChartFile, error) {
	...
	sf := stack.StackFile{
		APIVersionKind: stack.APIVersionKind{APIVersion: "ktl.dev/v1", Kind: "Stack"},
		Name:           stackName,
...
func renderDiscoveryHeader(snapshot *Snapshot, opts RenderOptions) string {
	...
	b.WriteString("# Generated by `ktl init from-cluster`.\n")
